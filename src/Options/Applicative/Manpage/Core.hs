module Options.Applicative.Manpage.Core where
...
import Options.Applicative.Types hiding (ParserHelp(..))
...
import Options.Applicative.Manpage.Types
import Options.Applicative.Manpage.Cabal (pinfo)


test :: IO ()
test = testing pinfo

testing :: ParserInfo a -> IO ()
testing pinf = putStrLn $ testing' pinf

testing' :: ParserInfo a -> String
testing' _ = ""
